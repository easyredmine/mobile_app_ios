//
//  ProjectDescriptionTableViewCell.m
//  EasyRedmine
//
...
static NSString *cellIdentifier = @"ProjectDescriptionTableViewCell";
...
-(void)layoutSubviews {
    ...
    self.descriptionLabel.preferredMaxLayoutWidth = self.bounds.size.width - 30;
}
